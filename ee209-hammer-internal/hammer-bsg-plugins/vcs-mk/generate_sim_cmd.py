...
def main ():
    ...
    if args.verdi:
        ...
        flags += [f"export VCS_HOME={os.path.join(env['synopsys.synopsys_home'],'verdi/V-2023.12-SP2/platform/verdi_supp',env['sim.vcs.version'])};"]
    ...
    ### VCS ###
        ...
        flags += [f"{os.path.join(env['synopsys.synopsys_home'],'verdi/V-2023.12-SP2/platform/verdi_supp',env['sim.vcs.version'])}/bin/vcs"]
        ### Common flags ###
