...
# Use UCLA "hammer_env.yml"
HAMMER_ENV ?= $(TOP_DIR)/hammer_env_UCLA.yml
...
#	HAMMER_ENV ?= /home/projects/ee478.2025spr/tsmc18/hammer_env.yml
#else 
...
HAMMER_EXTRA_ARGS := $(HAMMER_EXTRA_ARGS) -l hammer.log
